...
import {
  COLUMN_GROUPS,
  COLUMN_LABELS,
} from "../../../../shared/types/reviewColumns";
...
const STATUS_OPTIONS: { value: string | null; label: string }[] = [
  { value: null, label: "Alle statussen" },
...
export default function ReviewTableFilters({
  ...
  const activeStatusLabel =
    ...
    "Status filter";
  const statusActive = statusFilter !== null;
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
          <div className="relative w-full sm:max-w-[420px]">
            <input
              type="text"
              placeholder="Zoek op titel, code of bronsysteem..."
              value={searchQuery}
